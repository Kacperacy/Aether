...
pub const CASTLING_RIGHTS: [u8; 2] = [0b0011, 0b1100];
pub const CASTLING_RIGHTS_MASK: u8 = 0b1111;
pub const CASTLING_RIGHTS_SQUARES: [[usize; 2]; 4] = [[4, 6], [4, 2], [60, 62], [60, 58]];
pub const CASTLING_WHITE_KING: u8 = 0b0001;
pub const CASTLING_WHITE_QUEEN: u8 = 0b0010;
pub const CASTLING_BLACK_KING: u8 = 0b0100;
pub const CASTLING_BLACK_QUEEN: u8 = 0b1000;
pub const CASTLING_ROOKS: [usize; 4] = [7, 0, 63, 56];
